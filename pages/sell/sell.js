...
var that=this
    ...
    if (e.detail.value.name && e.detail.value.o_price && e.detail.value.phone_number && e.detail.value.s_price && e.detail.value.schoolarea && e.detail.value.sort && e.detail.value.wechat_number && e.detail.value.detail&&this.data.imgList.length>0){
